...
contract PollTryNextBlockHandler is BaseConditionalOrder {
    ...
    function generateOrder(address, bytes32, bytes calldata, bytes calldata)
        ...
        returns (GPv2Order.Data memory)
    {
        revert IConditionalOrderGenerator.PollTryNextBlock(reasonCode);
    }
}
...
contract NeedsOffchainInputHandler is BaseConditionalOrder {
    ...
    function generateOrder(address, bytes32, bytes calldata, bytes calldata offchainInput)
        ...
        returns (GPv2Order.Data memory)
    {
        require(offchainInput.length > 0, IConditionalOrderGenerator.PollNeedsOffchainInput(reasonCode));
...
contract PollTryAtTimestampHandler is BaseConditionalOrder {
    ...
    function generateOrder(address, bytes32, bytes calldata, bytes calldata)
        ...
        returns (GPv2Order.Data memory)
    {
        revert IConditionalOrderGenerator.PollTryAtTimestamp(timestamp, reasonCode);
    }
}
...
contract PollTryAtBlockHandler is BaseConditionalOrder {
    ...
    function generateOrder(address, bytes32, bytes calldata, bytes calldata)
        ...
        returns (GPv2Order.Data memory)
    {
        revert IConditionalOrderGenerator.PollTryAtBlock(blockNum, reasonCode);
    }
}
